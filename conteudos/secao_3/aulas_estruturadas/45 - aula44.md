...
Fonte Python editável: `../45 - aula44.py`

Bloco: **Repetições**

## Navegação

- Aula anterior: [WHILE E FOR EM PYTHON (LAÇOS DE REPETIÇÃO)](44 - aula43.md)
- Próxima aula: [ITERÁVEIS E ITERADORES EM PYTHON](46 - aula45.md)
