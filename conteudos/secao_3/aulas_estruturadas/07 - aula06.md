...
Fonte Python editável: `../07 - aula06.py`

Bloco: **Fundamentos**

## Navegação

- Aula anterior: [Tipo de Dado Booleano (bool) e Operador de Igualdade (==)](06 - aula05.md)
- Próxima aula: [VARIÁVEIS EM PYTHON](08 - aula07.md)
