...
Fonte Python editável: `../26 - aula25.py`

Bloco: **Strings, formatação e validação inicial**

## Navegação

- Aula anterior: [OPERADORES in E not in (STRINGS)](25 - aula24.md)
- Próxima aula: [FORMATAÇÃO DE STRINGS COM F-STRINGS](27 - aula26.md)
