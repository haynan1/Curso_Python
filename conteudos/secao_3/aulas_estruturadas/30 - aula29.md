...
Fonte Python editável: `../30 - aula29.py`

Bloco: **Strings, formatação e validação inicial**

## Navegação

- Aula anterior: [VALIDAÇÃO DE DADOS + STRINGS + CONDIÇÕES](29 - aula28.md)
- Próxima aula: [CONSTANTES, LEGIBILIDADE E COMPLEXIDADE](31 - aula30.md)
