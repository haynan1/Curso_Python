...
Fonte Python editável: `../02 - aula01.py`

Bloco: **Fundamentos**

## Navegação

- Aula anterior: [01 - arquivo_de_testes_0](01 - arquivo_de_testes_0.md)
- Próxima aula: [FUNÇÃO PRINT, SEPARADOR (sep) E FINALIZAÇÃO (end)](03 - aula02.md)
