# Aula 04 - STRINGS, ASPAS E ESCAPE NO PYTHON

Fonte Python editável: `../04 - aula03.py`

Bloco: **Fundamentos**

## Navegação

- Aula anterior: [FUNÇÃO PRINT, SEPARADOR (sep) E FINALIZAÇÃO (end)](03 - aula02.md)
- Próxima aula: [TIPOS NUMÉRICOS: INT E FLOAT NO PYTHON](05 - aula04.md)
