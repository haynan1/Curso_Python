...
Fonte Python editável: `../40 - aula39.py`

Bloco: **Repetições**

## Navegação

- Aula anterior: [LAÇOS DE REPETIÇÃO - WHILE (ENQUANTO)](39 - aula38.md)
- Próxima aula: [Calculadora com WHILE + Validação de Entrada + Try/Except](41 - aula40.md)
