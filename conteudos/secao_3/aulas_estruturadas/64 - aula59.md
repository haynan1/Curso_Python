...
Fonte Python editável: `../64 - aula59.py`

Bloco: **Dados, strings e estruturas**

## Navegação

- Aula anterior: [Interpretador do Python + Zen of Python](63 - aula58.md)
- Próxima aula: [Operador Ternário (Condicional em Uma Linha)](65 - aula60.md)
