...
Fonte Python editável: `../22 - aula21.py`

Bloco: **Decisões**

## Navegação

- Aula anterior: [ENTENDENDO COMPARAÇÃO DE STRINGS NO PYTHON](21 - aula20.md)
- Próxima aula: [OPERADOR LÓGICO OR EM PYTHON](23 - aula22.md)
