...
Fonte Python editável: `../66 - aula61.py`

Bloco: **Projeto CPF**

## Navegação

- Aula anterior: [Operador Ternário (Condicional em Uma Linha)](65 - aula60.md)
- Próxima aula: [Cálculo do Segundo Dígito Verificador do CPF](67 - aula62.1.md)
