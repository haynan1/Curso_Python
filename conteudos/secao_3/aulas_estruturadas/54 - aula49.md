...
Fonte Python editável: `../54 - aula49.py`

Bloco: **Coleções**

## Navegação

- Aula anterior: [CUIDADOS COM DADOS MUTÁVEIS](53 - aula48.5.md)
- Próxima aula: [Percorrendo Listas com Índices (range + len)](55 - aula50.md)
