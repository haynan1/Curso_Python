...
Fonte Python editável: `../47 - aula46.py`

Bloco: **Repetições**

## Navegação

- Aula anterior: [ITERÁVEIS E ITERADORES EM PYTHON](46 - aula45.md)
- Próxima aula: [JOGO DA PALAVRA SECRETA (FORCA SIMPLES)](48 - aula47.md)
