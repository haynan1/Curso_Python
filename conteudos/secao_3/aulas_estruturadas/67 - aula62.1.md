...
Fonte Python editável: `../67 - aula62.1.py`

Bloco: **Projeto CPF**

## Navegação

- Aula anterior: [Cálculo do Primeiro Dígito Verificador do CPF](66 - aula61.md)
- Próxima aula: [VALIDAÇÃO DE CPF (CÁLCULO DOS DÍGITOS)](68 - aula62.2.md)
