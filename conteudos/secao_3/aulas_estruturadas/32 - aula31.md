...
Fonte Python editável: `../32 - aula31.py`

Bloco: **Strings, formatação e validação inicial**

## Navegação

- Aula anterior: [CONSTANTES, LEGIBILIDADE E COMPLEXIDADE](31 - aula30.md)
- Próxima aula: [ESTRUTURAS CONDICIONAIS E TRATAMENTO DE ERROS](33 - aula32.md)
